...
export default function FourthYearPage() {
  ...
  const subjects = [
    { id: "all", name: "All Subjects", icon: BookOpen, count: 62 },
    { id: "cardio", name: "Cardiopulmonary Sciences", icon: Heart, count: 12 },
    { id: "ortho", name: "Physiotherapy in Orthopaedics", icon: Dumbbell, count: 15 },
    { id: "neuro", name: "Physiotherapy in Neurology", icon: Brain, count: 12 },
    { id: "respiratory", name: "Cardio-Respiratory Conditions", icon: Activity, count: 10 },
    { id: "community", name: "Community-Based Rehabilitation", icon: Users, count: 6 },
    { id: "ethics", name: "Ethics & Administration", icon: Shield, count: 4 },
    { id: "clinical", name: "Clinical Education", icon: ClipboardList, count: 3 }
  ];
  ...
  const featuredBooks = [
    {
      ...
      edition: "6th Edition",
      year: "2024",
      subject: "Cardiopulmonary Sciences",
    ...
    },
    {
      ...
      edition: "7th Edition",
      year: "2023",
      subject: "Physiotherapy in Orthopaedics",
  ...
  const allBooks = [
    ...featuredBooks,
    {
      ...
      author: "Dean R. Hess, Neil R. MacIntyre, William F. Galvin",
      edition: "4th Edition",
      year: "2024",
      subject: "Cardio-Respiratory Conditions",
      description: "Comprehensive respiratory care textbook with clinical applications and protocols.",
      difficulty: "Advanced",
      pages: 896,
      rating: 4.6,
      views: 1567,
    ...
    },
    {
      ...
      description: "Comprehensive guide to community-based rehabilitation principles and practices.",
    ...
    {
      title: "Healthcare Ethics and Administration",
      author: "John F. Monagle, David C. Thomasma",
      edition: "5th Edition",
      year: "2022",
      subject: "Ethics & Administration",
      description: "Comprehensive guide to healthcare ethics and administrative practices.",
      difficulty: "Intermediate",
      pages: 384,
      rating: 4.4,
      views: 2345,
  ...
  return (
    <div className="flex min-h-screen flex-col bg-background">
      ...
      <main className="flex-1">
        ...
        <section className="py-4 sm:py-6 bg-white/50 border-b border-border/50">
          <div className="container max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <nav className="flex items-center space-x-2 text-sm text-muted-foreground">
              ...
              <span>/</span>
              <span className="text-foreground font-medium">Fourth Year</span>
            </nav>
          </div>
        </section>

        {/* Hero Section */}
        <section className="bg-gradient-to-br from-orange-500/10 via-red-500/10 to-pink-500/10 py-12 sm:py-16 md:py-20 lg:py-32 relative overflow-hidden">
          {/* Background Elements */}
          <div className="absolute inset-0 overflow-hidden pointer-events-none">
            <div className="absolute top-1/4 left-1/6 w-1 h-1 bg-orange-500/60 rounded-full animate-pulse-slow"></div>
            <div className="absolute top-1/3 right-1/4 w-0.5 h-0.5 bg-red-500/70 rounded-full animate-pulse-slow" style={{animationDelay: '1s'}}></div>
            <div className="absolute bottom-1/3 left-1/3 w-1.5 h-1.5 bg-pink-500/50 rounded-full animate-pulse-slow" style={{animationDelay: '2s'}}></div>
          </div>
          
          <div className="container max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="text-center max-w-4xl mx-auto">
              <Badge className="bg-orange-500/10 text-orange-600 border-orange-500/20 px-3 sm:px-4 py-2 mb-4 sm:mb-6 animate-fade-in text-xs sm:text-sm">
              ...
              <p className="text-base sm:text-lg md:text-xl text-muted-foreground mb-6 sm:mb-8 leading-relaxed px-4 sm:px-0">
                Specialized physiotherapy practice and clinical applications. Access comprehensive textbooks, 
                specialized guides, and resources for your final year of physiotherapy education.
              </p>
              ...
              <div className="relative max-w-2xl mx-auto mb-6 sm:mb-8">
                ...
                <Input
                  ...
                  className="w-full pl-10 sm:pl-12 pr-4 py-3 sm:py-4 bg-white/80 backdrop-blur-sm border border-border/50 rounded-xl text-foreground placeholder:text-muted-foreground/50 focus:outline-none focus:ring-2 focus:ring-orange-500/50 focus:border-orange-500/50 transition-all duration-500 ease-out text-sm sm:text-base shadow-lg"
                />
              </div>
          ...
          <div className="container max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12 sm:mb-16">
              ...
              <p className="text-base sm:text-lg text-muted-foreground max-w-2xl mx-auto px-4 sm:px-0">
                Essential textbooks recommended for fourth-year BPT students.
              </p>
            </div>
              ...
              {featuredBooks.map((book, index) => (
                <Card key={book.title} className="group hover:shadow-xl transition-all duration-500 hover:-translate-y-2 border-0 shadow-lg overflow-hidden">
                  ...
                  <CardHeader className="pb-4">
                    ...
                    <CardTitle className="text-lg sm:text-xl font-headline group-hover:text-orange-600 transition-colors duration-300">
                      {book.title}
                    </CardTitle>
        ...
        <section className="py-12 sm:py-16">
          <div className="container max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12 sm:mb-16">
              ...
              <p className="text-base sm:text-lg text-muted-foreground max-w-2xl mx-auto px-4 sm:px-0">
                Complete collection of fourth-year BPT textbooks and study materials.
              </p>
            </div>
              ...
              {searchedBooks.map((book, index) => (
                <Card key={book.title} className="group hover:shadow-lg transition-all duration-300 hover:-translate-y-1 border-0 shadow-md overflow-hidden">
                  ...
                  <CardHeader className="pb-3">
                    ...
                    <CardTitle className="text-base font-headline group-hover:text-orange-600 transition-colors duration-300 line-clamp-2">
                      {book.title}
                    </CardTitle>
        ...
        <section className="py-12 sm:py-16 bg-gradient-to-br from-orange-500/5 via-red-500/5 to-pink-500/5">
          <div className="container max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12 sm:mb-16">
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold font-headline mb-3 sm:mb-4">
                Explore Other
