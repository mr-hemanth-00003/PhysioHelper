...
export default function SecondYearPage() {
  ...
  const subjects = [
    { id: "all", name: "All Subjects", icon: BookOpen, count: 52 },
    { id: "pathology", name: "Pathology", icon: Microscope, count: 8 },
    { id: "microbiology", name: "Microbiology", icon: Microscope, count: 6 },
    { id: "pharmacology", name: "Pharmacology", icon: Pill, count: 10 },
    { id: "exercise", name: "Exercise Therapy", icon: Dumbbell, count: 12 },
    { id: "electrotherapy", name: "Electrotherapy", icon: Lightning, count: 8 },
    { id: "biomechanics", name: "Biomechanics & Kinesiology", icon: Activity, count: 6 },
    { id: "psychology", name: "Psychology", icon: Brain, count: 2 }
  ];
  ...
  const featuredBooks = [
    {
      ...
      year: "2024",
      subject: "Pathology",
      description: "Comprehensive pathology textbook with clinical correlations and case studies.",
    ...
    },
    {
      ...
      description: "Comprehensive guide to therapeutic exercise techniques and rehabilitation protocols.",
      difficulty: "Intermediate",
      pages: 768,
      rating: 4.9,
      views: 3456,
    ...
    {
      title: "Clinical Electrotherapy",
      author: "Steven L. Wolf",
      edition: "6th Edition",
      year: "2023",
      subject: "Electrotherapy",
      description: "Evidence-based approach to electrotherapy with clinical applications and protocols.",
      difficulty: "Advanced",
      pages: 432,
      rating: 4.7,
      views: 2156,
  ...
  const allBooks = [
    ...featuredBooks,
    {
      ...
      description: "Comprehensive kinesiology textbook with biomechanical analysis and clinical applications.",
      difficulty: "Advanced",
      pages: 672,
      rating: 4.6,
      views: 1567,
    ...
    },
    {
      ...
      description: "Comprehensive pharmacology textbook with clinical applications and drug interactions.",
      difficulty: "Advanced",
      pages: 1248,
      rating: 4.5,
      views: 987,
    ...
    },
    {
      ...
      description: "Comprehensive microbiology textbook with clinical correlations and case studies.",
      difficulty: "Intermediate",
      pages: 896,
      rating: 4.4,
      views: 2345,
  ...
  return (
    <div className="flex min-h-screen flex-col bg-background">
      ...
      <main className="flex-1">
        ...
        {/* Hero Section */}
        <section className="bg-gradient-to-br from-blue-500/10 via-cyan-500/10 to-sky-500/10 py-12 sm:py-16 md:py-20 lg:py-32 relative overflow-hidden">
          {/* Background Elements */}
          <div className="absolute inset-0 overflow-hidden pointer-events-none">
            <div className="absolute top-1/4 left-1/6 w-1 h-1 bg-blue-500/60 rounded-full animate-pulse-slow"></div>
            <div className="absolute top-1/3 right-1/4 w-0.5 h-0.5 bg-cyan-500/70 rounded-full animate-pulse-slow" style={{animationDelay: '1s'}}></div>
            <div className="absolute bottom-1/3 left-1/3 w-1.5 h-1.5 bg-sky-500/50 rounded-full animate-pulse-slow" style={{animationDelay: '2s'}}></div>
          </div>
          
          <div className="container max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="text-center max-w-4xl mx-auto">
              <Badge className="bg-blue-500/10 text-blue-600 border-blue-500/20 px-3 sm:px-4 py-2 mb-4 sm:mb-6 animate-fade-in text-xs sm:text-sm">
                <BookOpenCheck className="h-3 w-3 sm:h-4 sm:w-4 mr-2" />
                Second Year BPT
              </Badge>
              ...
              <p className="text-base sm:text-lg md:text-xl text-muted-foreground mb-6 sm:mb-8 leading-relaxed px-4 sm:px-0">
                Core physiotherapy subjects and therapeutic techniques. Access comprehensive textbooks, 
                practical guides, and resources for your second year of physiotherapy education.
              </p>
              ...
              <div className="relative max-w-2xl mx-auto mb-6 sm:mb-8">
                ...
                <Input
                  ...
                  className="w-full pl-10 sm:pl-12 pr-4 py-3 sm:py-4 bg-white/80 backdrop-blur-sm border border-border/50 rounded-xl text-foreground placeholder:text-muted-foreground/50 focus:outline-none focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500/50 transition-all duration-500 ease-out text-sm sm:text-base shadow-lg"
                />
              </div>
          ...
          <div className="container max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12 sm:mb-16">
              ...
              <p className="text-base sm:text-lg text-muted-foreground max-w-2xl mx-auto px-4 sm:px-0">
                Essential textbooks recommended for second-year BPT students.
              </p>
            </div>
              ...
              {featuredBooks.map((book, index) => (
                <Card key={book.title} className="group hover:shadow-xl transition-all duration-500 hover:-translate-y-2 border-0 shadow-lg overflow-hidden">
                  ...
                  <CardHeader className="pb-4">
                    ...
                    <CardTitle className="text-lg sm:text-xl font-headline group-hover:text-blue-600 transition-colors duration-300">
                      {book.title}
                    </CardTitle>
                  ...
                  <CardContent className="space-y-4">
                    ...
                    <div className="flex gap-2 pt-4">
                      <Button className="flex-1 bg-gradient-to-r from-blue-500 to-cyan-600 hover:from-blue-600 hover:to-cyan-700 text-white">
        ...
        <section className="py-12 sm:py-16">
          <div className="container max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12 sm:mb-16">
              ...
              <p className="text-base sm:text-lg text-muted-foreground max-w-2xl mx-auto px-4 sm:px-0">
                Complete collection of second-year BPT textbooks and study materials.
              </p>
            </div>
              ...
              {searchedBooks.map((book, index) => (
                <Card key={book.title} className="group hover:shadow-lg transition-all duration-300 hover:-translate-y-1 border-0 shadow-md overflow-hidden">
                  ...
                  <CardHeader className="pb-3">
                    ...
                    <CardTitle className="text-base font-headline group-hover:text-blue-600 transition-colors duration-300 line-clamp-2">
                      {book.title}
                    </CardTitle>
        ...
        <section className="py-12 sm:py-16 bg-gradient-to-br from-blue-500/5 via-cyan-500/5 to-sky-500/5">
          <div className="container max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12 sm:mb-16">
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold font-headline mb-3 sm:mb-4">
                Explore Other
