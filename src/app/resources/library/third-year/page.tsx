...
export default function ThirdYearPage() {
  const [searchQuery, setSearchQuery] = useState("");
  const [selectedSubject, setSelectedSubject] = useState("all");

  const subjects = [
    { id: "all", name: "All Subjects", icon: BookOpen, count: 58 },
    { id: "medicine", name: "General Medicine", icon: Stethoscope, count: 10 },
    { id: "surgery", name: "General Surgery", icon: Stethoscope, count: 8 },
    { id: "orthopaedics", name: "Orthopaedics", icon: Dumbbell, count: 12 },
    { id: "neurology", name: "Neurology & Neurosurgery", icon: Brain, count: 10 },
    { id: "community", name: "Community Medicine", icon: Users, count: 6 },
    { id: "electrotherapy", name: "Physical Agents & Electrotherapy", icon: Zap, count: 8 },
    { id: "research", name: "Research & Biostatistics", icon: Calculator, count: 4 }
  ];

  const featuredBooks = [
    {
      title: "Harrison's Principles of Internal Medicine",
      author: "Dennis L. Kasper, Anthony S. Fauci, Stephen L. Hauser",
      edition: "21st Edition",
      year: "2024",
      subject: "General Medicine",
      description: "Comprehensive internal medicine textbook with clinical correlations and evidence-based approaches.",
      difficulty: "Advanced",
      pages: 3200,
      rating: 4.9,
      views: 3456,
    ...
    },
    {
      ...
      description: "Comprehensive orthopaedic surgery textbook with surgical techniques and clinical outcomes.",
      difficulty: "Advanced",
      pages: 4800,
      rating: 4.8,
      views: 2891,
    ...
    },
    {
      ...
      description: "Comprehensive neurology textbook with clinical correlations and diagnostic approaches.",
      difficulty: "Advanced",
      pages: 1600,
      rating: 4.7,
      views: 2156,
  ...
  const allBooks = [
    ...featuredBooks,
    {
      ...
      description: "Comprehensive surgery textbook with surgical techniques and clinical management.",
      difficulty: "Advanced",
      pages: 2048,
      rating: 4.6,
      views: 1567,
    ...
    {
      title: "Community Medicine and Public Health",
      author: "A. K. Park, K. Park",
      edition: "26th Edition",
      year: "2023",
      subject: "Community Medicine",
      description: "Comprehensive community medicine textbook with public health principles and epidemiology.",
    ...
    {
      title: "Clinical Research Methodology and Biostatistics",
      author: "P. S. S. Sundar Rao, J. Richard",
      edition: "4th Edition",
      year: "2022",
      subject: "Research & Biostatistics",
      description: "Guide to research methodology and statistical analysis in clinical research.",
      difficulty: "Advanced",
      pages: 432,
      rating: 4.4,
      views: 2345,
      ...
      <main className="flex-1">
        ...
        <section className="bg-gradient-to-br from-purple-500/10 via-violet-500/10 to-fuchsia-500/10 py-12 sm:py-16 md:py-20 lg:py-32 relative overflow-hidden">
          ...
          <div className="absolute inset-0 overflow-hidden pointer-events-none">
            <div className="absolute top-1/4 left-1/6 w-1 h-1 bg-purple-500/60 rounded-full animate-pulse-slow"></div>
            <div className="absolute top-1/3 right-1/4 w-0.5 h-0.5 bg-violet-500/70 rounded-full animate-pulse-slow" style={{animationDelay: '1s'}}></div>
            <div className="absolute bottom-1/3 left-1/3 w-1.5 h-1.5 bg-fuchsia-500/50 rounded-full animate-pulse-slow" style={{animationDelay: '2s'}}></div>
          </div>
          
          <div className="container max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="text-center max-w-4xl mx-auto">
              <Badge className="bg-purple-500/10 text-purple-600 border-purple-500/20 px-3 sm:px-4 py-2 mb-4 sm:mb-6 animate-fade-in text-xs sm:text-sm">
              ...
              <p className="text-base sm:text-lg md:text-xl text-muted-foreground mb-6 sm:mb-8 leading-relaxed px-4 sm:px-0">
                Clinical subjects and specialized physiotherapy areas. Access comprehensive textbooks, 
                clinical guides, and resources for your third year of physiotherapy education.
              </p>
              ...
              <div className="relative max-w-2xl mx-auto mb-6 sm:mb-8">
                ...
                <Input
                  ...
                  className="w-full pl-10 sm:pl-12 pr-4 py-3 sm:py-4 bg-white/80 backdrop-blur-sm border border-border/50 rounded-xl text-foreground placeholder:text-muted-foreground/50 focus:outline-none focus:ring-2 focus:ring-purple-500/50 focus:border-purple-500/50 transition-all duration-500 ease-out text-sm sm:text-base shadow-lg"
                />
              </div>
          ...
          <div className="container max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12 sm:mb-16">
              ...
              <p className="text-base sm:text-lg text-muted-foreground max-w-2xl mx-auto px-4 sm:px-0">
                Essential textbooks recommended for third-year BPT students.
              </p>
            </div>
              ...
              {featuredBooks.map((book, index) => (
                <Card key={book.title} className="group hover:shadow-xl transition-all duration-500 hover:-translate-y-2 border-0 shadow-lg overflow-hidden">
                  ...
                  <CardHeader className="pb-4">
                    ...
                    <CardTitle className="text-lg sm:text-xl font-headline group-hover:text-purple-600 transition-colors duration-300">
                      {book.title}
                    </CardTitle>
                  ...
                  <CardContent className="space-y-4">
                    ...
                    <div className="flex gap-2 pt-4">
                      <Button className="flex-1 bg-gradient-to-r from-purple-500 to-violet-600 hover:from-purple-600 hover:to-violet-700 text-white">
        ...
        <section className="py-12 sm:py-16">
          <div className="container max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12 sm:mb-16">
              ...
              <p className="text-base sm:text-lg text-muted-foreground max-w-2xl mx-auto px-4 sm:px-0">
                Complete collection of third-year BPT textbooks and study materials.
              </p>
            </div>
              ...
              {searchedBooks.map((book, index) => (
                <Card key={book.title} className="group hover:shadow-lg transition-all duration-300 hover:-translate-y-1 border-0 shadow-md overflow-hidden">
                  ...
                  <CardHeader className="pb-3">
                    ...
                    <CardTitle className="text-base font-headline group-hover:text-purple-600 transition-colors duration-300 line-clamp-2">
                      {book.title}
                    </CardTitle>
        ...
        <section className="py-12 sm:py-16 bg-gradient-to-br from-purple-500/5 via-violet-500/5 to-fuchsia-500/5">
          <div className="container max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12 sm:mb-16">
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold font-headline mb-3 sm:mb-4">
                Explore Other
