...
export default function InternshipPage() {
  ...
  const postings = [
    { id: "all", name: "All Postings", icon: BookOpen, count: 45 },
    { id: "ortho", name: "Orthopaedics", icon: Dumbbell, count: 12 },
    { id: "neuro", name: "Neurology", icon: Brain, count: 10 },
    { id: "cardio", name: "Cardio-Respiratory", icon: Heart, count: 8 },
    { id: "community", name: "Community Health", icon: Users, count: 6 },
    { id: "medicine", name: "General Medicine & Surgery", icon: Stethoscope, count: 5 },
    { id: "icu", name: "ICU", icon: Monitor, count: 3 },
    { id: "pediatrics", name: "Pediatrics", icon: Baby, count: 1 }
  ];

  const featuredBooks = [
    {
      title: "Clinical Handbook of Physical Therapy",
      author: "Catherine C. Goodman, Teresa E. Kelly Snyder",
      edition: "7th Edition",
      year: "2024",
      posting: "All Postings",
      description: "Comprehensive clinical handbook covering all major physiotherapy areas with practical guidelines.",
      difficulty: "Advanced",
      pages: 896,
      rating: 4.9,
      views: 3456,
    ...
    },
    {
      ...
      description: "Comprehensive orthopedic assessment techniques with clinical reasoning frameworks.",
      difficulty: "Advanced",
      pages: 1152,
      rating: 4.8,
      views: 2891,
    ...
    },
    {
      ...
      year: "2023",
      posting: "Neurology",
      description: "Evidence-based approaches to neurological rehabilitation with treatment protocols.",
      difficulty: "Advanced",
      pages: 1248,
      rating: 4.7,
      views: 2156,
  ...
  const allBooks = [
    ...featuredBooks,
    {
      ...
      edition: "6th Edition",
      year: "2024",
      posting: "Cardio-Respiratory",
      description: "Comprehensive guide to cardiopulmonary physical therapy with evidence-based approaches.",
      difficulty: "Advanced",
      pages: 768,
      rating: 4.6,
      views: 1567,
    ...
    {
      title: "Community Health and Rehabilitation",
      author: "World Health Organization",
      edition: "3rd Edition",
      year: "2023",
      posting: "Community Health",
      description: "Comprehensive guide to community health and rehabilitation principles and practices.",
    ...
    {
      title: "ICU Physical Therapy Manual",
      author: "Linda D. Denehy, Selina M. Parry",
      edition: "2nd Edition",
      year: "2022",
      posting: "ICU",
      description: "Practical manual for physical therapy in intensive care units with protocols and guidelines.",
      difficulty: "Advanced",
      pages: 384,
      rating: 4.4,
      views: 2345,
  ...
  const filteredBooks = selectedPosting === "all" 
    ? allBooks 
    : allBooks.filter(book => book.posting.toLowerCase().includes(selectedPosting));
  ...
  const searchedBooks = searchQuery 
    ? filteredBooks.filter(book =>
        ...
        book.posting.toLowerCase().includes(searchQuery.toLowerCase())
      )
    : filteredBooks;
      ...
      <main className="flex-1">
        ...
        <section className="bg-gradient-to-br from-indigo-500/10 via-blue-500/10 to-cyan-500/10 py-12 sm:py-16 md:py-20 lg:py-32 relative overflow-hidden">
          ...
          <div className="absolute inset-0 overflow-hidden pointer-events-none">
            <div className="absolute top-1/4 left-1/6 w-1 h-1 bg-indigo-500/60 rounded-full animate-pulse-slow"></div>
            <div className="absolute top-1/3 right-1/4 w-0.5 h-0.5 bg-blue-500/70 rounded-full animate-pulse-slow" style={{animationDelay: '1s'}}></div>
            <div className="absolute bottom-1/3 left-1/3 w-1.5 h-1.5 bg-cyan-500/50 rounded-full animate-pulse-slow" style={{animationDelay: '2s'}}></div>
          </div>
          
          <div className="container max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="text-center max-w-4xl mx-auto">
              <Badge className="bg-indigo-500/10 text-indigo-600 border-indigo-500/20 px-3 sm:px-4 py-2 mb-4 sm:mb-6 animate-fade-in text-xs sm:text-sm">
              ...
              <p className="text-base sm:text-lg md:text-xl text-muted-foreground mb-6 sm:mb-8 leading-relaxed px-4 sm:px-0">
                Duration: 6-12 months (varies by university). Access comprehensive resources, guides, and 
                practical materials for all internship postings and clinical rotations.
              </p>
              ...
              <div className="relative max-w-2xl mx-auto mb-6 sm:mb-8">
                ...
                <Input
                  type="text"
                  placeholder="Search for books, authors, postings, and more..."
                  value={searchQuery}
                  onChange={(e) => setSearchQuery(e.target.value)}
                  className="w-full pl-10 sm:pl-12 pr-4 py-3 sm:py-4 bg-white/80 backdrop-blur-sm border border-border/50 rounded-xl text-foreground placeholder:text-muted-foreground/50 focus:outline-none focus:ring-2 focus:ring-indigo-500/50 focus:border-indigo-500/50 transition-all duration-500 ease-out text-sm sm:text-base shadow-lg"
                />
              </div>
          ...
          <div className="container max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12 sm:mb-16">
              ...
              <p className="text-base sm:text-lg text-muted-foreground max-w-2xl mx-auto px-4 sm:px-0">
                Essential resources recommended for internship students across all postings.
              </p>
            </div>
                ...
                <Card key={book.title} className="group hover:shadow-xl transition-all duration-500 hover:-translate-y-2 border-0 shadow-lg overflow-hidden">
                  ...
                  <CardHeader className="pb-4">
                    <div className="flex items-start justify-between mb-3">
                      ...
                      <div className="flex gap-2">
                        ...
                        {book.isFeatured && (
                          <Badge className="bg-indigo-500 text-white text-xs">Featured</Badge>
                        )}
                      </div>
                    </div>
                    <CardTitle className="text-lg sm:text-xl font-headline group-hover:text-indigo-600 transition-colors duration-300">
                      {book.title}
                    </CardTitle>
                  ...
                  <CardContent className="space-y-4">
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="text-sm">
                        <span className="font-semibold text-foreground">Posting:</span>
                        <span className="text-muted-foreground ml-2">{book.posting}</span>
                      </div>
                      <div className="text-sm">
                    ...
                    <div className="flex gap-2 pt-4">
                      <Button className="flex-1 bg-gradient-to-r from-indigo-500 to-blue-600 hover:from-indigo-600 hover:to-blue-700 text-white">
        ...
        <section className="py-12 sm:py-16">
          <div className="container max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12 sm:mb-16">
              ...
              <p className="text-base sm:text-lg text-muted-foreground max-w-2xl mx-auto px-4 sm:px-0">
                Complete collection of internship resources and study materials.
              </p>
            </div>
              ...
              {searchedBooks.map((book, index) => (
                <Card key={book.title} className="group hover:shadow-lg transition-all duration-300 hover:-translate-y-1 border-0 shadow-md overflow-hidden">
                  ...
                  <CardHeader className="pb-3">
                    ...
                    <CardTitle className="text-base font-headline group-hover:text-indigo-600 transition-colors duration-300 line-clamp-2">
                      {book.title}
                    </CardTitle>
                  ...
                  <CardContent className="space-y-3">
                    ...
                    <div className="space-y-2 text-xs">
                      ...
                      <div className="flex gap-4">
                        <span className="font-semibold text-foreground">{book.posting}</span>
              ...
              <Card className="text-center py-16">
                <CardContent>
                  ...
                  <p className="text-muted-foreground mb-6 max-w-md mx-auto">
                    Try adjusting your search criteria or browse by posting to discover relevant books.
                  </p>
                  <Button onClick={() => { setSearchQuery(''); setSelectedPosting('all'); }} variant="outline">
                    Clear All Filters
                  </Button>
                </CardContent>
              </Card>
        ...
        <section className="py-12 sm:py-16 bg-gradient-to-br from-indigo-500/5 via-blue-500/5 to-cyan-500/5">
          <div className="container max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12 sm:mb-16">
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold font-headline mb-3 sm:mb-4">
                Explore Other
              ...
              <Link href="/resources/library/first-year">
                <Card className="group hover:shadow-xl transition-all duration-500 hover:-translate-y-2 border-0 shadow-lg overflow-hidden cursor-pointer">
                  ...
                  <CardHeader className="pb-4">
                    ...
                    <CardTitle className="text-xl font-headline group-hover:text-green-600 transition-colors duration-300">
                      First Year BPT
                    </CardTitle>
                    <CardDescription className="text-sm text-muted-foreground">
