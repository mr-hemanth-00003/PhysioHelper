...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="py-12 sm:py-16 md:py-20 bg-gradient-to-br from-blue-50 to-indigo-50 relative overflow-hidden">
        <div className="container max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center mb-12 sm:mb-16 animate-fade-in-up">
            <Badge className="bg-blue-100 text-blue-800 border-blue-200 px-3 sm:px-4 py-2 text-xs sm:text-sm font-medium mb-3 sm:mb-4 animate-pulse-glow">
              Featured Courses
            </Badge>
            <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-headline font-bold mb-4 sm:mb-6">
              Master Physiotherapy
              <span className="text-blue-600 block">Through Structured Learning</span>
            </h2>
            <p className="text-base sm:text-lg md:text-xl text-muted-foreground max-w-3xl mx-auto px-4 sm:px-0">
              Explore our comprehensive curriculum designed by leading physiotherapy educators. 
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 max-w-6xl mx-auto">
            <Card className="group hover:shadow-xl transition-all duration-300 hover:-translate-y-1 border-0 bg-white/80 backdrop-blur-sm">
              <CardHeader className="pb-4">
                ...
                <CardDescription className="text-muted-foreground leading-relaxed">
                  Master the fundamental structure and function of the human body through interactive learning.
                </CardDescription>
              </CardHeader>
            ...
            <Card className="group hover:shadow-xl transition-all duration-300 hover:-translate-y-1 border-0 bg-white/80 backdrop-blur-sm">
              <CardHeader className="pb-4">
                ...
                <CardDescription className="text-muted-foreground leading-relaxed">
                  Study movement mechanics and human motion analysis for clinical practice.
                </CardDescription>
              </CardHeader>
            ...
            <Card className="group hover:shadow-xl transition-all duration-300 hover:-translate-y-1 border-0 bg-white/80 backdrop-blur-sm">
              <CardHeader className="pb-4">
                ...
                <CardDescription className="text-muted-foreground leading-relaxed">
                  Master clinical assessment methods and diagnostic techniques.
                </CardDescription>
              </CardHeader>
